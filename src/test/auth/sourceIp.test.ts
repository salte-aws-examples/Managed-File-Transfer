...
describe("sourceIp", () => {
  ...
  test("parseAllowedSourceCidrs parses JSON array", () => {
    expect(parseAllowedSourceCidrs('["203.0.113.42/32"]')).toEqual([
      "203.0.113.42/32",
    ]);
  });
